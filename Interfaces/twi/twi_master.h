...
#define TWI_DELAY() nrf_delay_us(2) /*!< Time to wait when pin states are changed. For fast-mode the delay can be zero and for standard-mode 4 us delay is sufficient. */
...
bool twi_master_enable(bool state); // true to enable, false to disable
/**
